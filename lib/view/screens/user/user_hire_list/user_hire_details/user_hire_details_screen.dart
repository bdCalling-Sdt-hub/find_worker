...
import 'package:wocontacts/view/screens/user/user_hire_list/Controller/hire_controller.dart';
...
class _UserHireDetailsScreenState extends State<UserHireDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   ],),),
      appBar: AppBar(
        title: Text(AppStrings.hireDetails.tr),
        leading: CustomBack(),
      ),
      body: LayoutBuilder(
          builder: (BuildContext context, BoxConstraints constraints) {
        return Obx(
          () => _controller.hireLoading.value
              ? const CustomLoader()
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: NetworkImage(
                                    _controller.hireDetails.value.image!),
                                fit: BoxFit.cover)),
                      ),
                      const SizedBox(
                        height: 16,
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    CustomText(
                                      text:
                                          '(${_controller.hireDetails.value.averageRating})',
                                      fontWeight: FontWeight.w500,
                                      left: 4,
                                    ),
                                  ],
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                color: _controller.hireDetails.value.status ==
                                    ...
                                    : _controller.hireDetails.value.status ==
                                        ...
                                        ? AppColors.green_10
                                        : _controller
                                                    .hireDetails.value.status ==
                                                AppConstants.approved
                                            ? AppColors.blue_10
                                            : _controller.hireDetails.value
                                                        .status ==
                        ...
                        children: [
                          ...
                          CustomText(
                            text: DateFormat.jm().format(
                                _controller.hireDetails.value.createAt!),
                            fontWeight: FontWeight.w500,
                            left: 4,
                          ),
                        ],
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          CustomText(
                            text:
                                "${DateFormat.d('en_US').format(_controller.hireDetails.value.createAt!)} ${DateFormat.MMMM('en_US').format(_controller.hireDetails.value.createAt!)}",
                            fontWeight: FontWeight.w500,
                            left: 4,
                          ),
                        ],
                      ...
                      if (_controller.hireDetails.value.status ==
                          AppConstants.approved)
    ...
    return Column(
      children: [
        ...
        CustomOutlineButton(
          onTap: () {
            showDialog(
                context: context, builder: (_) => HireDetailsCancelDialog());
          },
        ...
        children: [
          ...
          CustomOutlineButton(
              onTap: () {
                showDialog(
                    context: context,
                    builder: (_) => HireDetailsCancelDialog());
              },
              text: AppStrings.cancel.tr)
        ],
      ),
