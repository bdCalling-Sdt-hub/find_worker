              ...
              builder: (BuildContext context, BoxConstraints constraints) {
                return SingleChildScrollView(
                    child: FutureBuilder<DocumentSnapshot>(
                      future: FirebaseFirestore.instance.collection(AppConstants.users).doc(firebaseAuth.currentUser?.uid).get(),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              CustomText(
                                                text: '${userData.dob!.day}-${userData.dob!.month}-${userData.dob!.year}',
                                                left: 12,
                                              )
                                            ],
                                          ),
