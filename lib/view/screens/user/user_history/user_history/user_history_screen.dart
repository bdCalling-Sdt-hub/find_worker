        ...
        child: Scaffold(
          ...
          body: LayoutBuilder(
              builder: (BuildContext context, BoxConstraints constraints) {
                return Obx(()=>_controller.loading.value?const CustomLoader():_controller.historyList.isEmpty?
                    Center(
                  child: Column(
                   ...
                   RefreshIndicator(
                     ...
                     child: SingleChildScrollView(
                       physics: const AlwaysScrollableScrollPhysics(),
                        ...
                        child: Column(
                          children:List.generate(_controller.historyList.length, (index) => GestureDetector(
                            onTap: (){
                              Get.to(UserHistoryDetailsScreen(historyModel:_controller.historyList[index], index: index));
                            },
                            child: Container(
                              ...
                              //    const CustomImage(imageSrc: AppImages.hireListProfile,imageType: ImageType.png,size: 100,),
                                  CachedNetworkImage(imageUrl:_controller.historyList[index].image!,imageBuilder:(context,widget){
                                    return Container(
                                       width: 155.w,
                                        height: 100.h,
                                      decoration: BoxDecoration(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Flexible(
                                                child: CustomText(
                                                  text:_controller.historyList[index].name!,
                                                  fontSize: 14,
                                          ...
                                          const SizedBox(height: 8,),
                                           Row(
                                            children: [
                                              ...
                                              CustomText(
                                                text: '(${_controller.historyList[index].averageRating})',
                                                fontSize: 10,
                                                left: 4,
                                              )
                                            ],
                                          ...
                                          const SizedBox(height: 8,),
                                           Row(
                                            children: [
                                               const CustomImage(imageSrc: AppIcons.service,imageColor: AppColors.black_100,size: 18,),
                                              Flexible(
                                                child: CustomText(
                                                  text: _controller.historyList[index].serviceName!,
                                                  fontSize: 10,
                                                  maxLines: 1,
                                           ...
                                           Row(
                                            ...
                                            children: [
                                              Flexible(
                                                child: Row(
                                                  children: [
                                                    const CustomImage(imageSrc: AppIcons.dateOfBirth,imageColor: AppColors.black_60,size: 14,),
                                                    CustomText(
                                                      text: DateFormat('dd MMM').format(_controller.historyList[index].createAt!),
                                                      fontSize: 10,
                                              ...
                                              Row(
                                                children: [
                                                  const CustomImage(imageSrc: AppIcons.clock,imageColor: AppColors.black_60,size: 14,),
                                                  CustomText(
                                                    text:DateFormat.jm().format(_controller.historyList[index].createAt!),
                                                    fontSize: 10,
                                                    color: AppColors.black_60,
                                                    left: 8,
                                                  ),
