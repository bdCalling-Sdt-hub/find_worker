                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: (value) {
                                      if (value == "") {
                                        return "Please enter a valid date.".tr;
                                      } else if (value!.length > 2) {
                                        return "Date not more then 2 digits".tr;
                                      } else {
                                        return null;
                                      }
                                    },
                                ...
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    validator: (value) {
                                      if (value == "") {
                                        return "Please enter a valid Month.".tr;
                                      } else if (value!.length > 2) {
                                        return "Month date not more then 2 digits".tr;
                                      } else {
                                        return null;
                                      }
                                    },
                                ...
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    validator: (value) {
                                      if (value == "") {
                                        return "Please enter a valid Year.".tr;
                                      } else if (value!.length > 4) {
                                        return "Year not more then 4 digits".tr;
                                      } else if (value.length < 4) {
                                        return "Year not less than 4 digits".tr;
                                      } else {
                                        return null;
                                      }
                                    },
