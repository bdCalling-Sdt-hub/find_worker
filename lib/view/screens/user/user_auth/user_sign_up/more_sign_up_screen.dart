...
class MoreSignUpScreen extends StatefulWidget {
  const MoreSignUpScreen({super.key,required this.uid,required this.email,required this.image,required this.name,required this.userType});
...
class _MoreSignUpScreenState extends State<MoreSignUpScreen> {
  ...
  @override
  void initState() {
    authController.emailController.text=widget.email;
    authController.nameController.text=widget.name;
    super.initState();
  }
                            ...
                            child: Column(children: [
                              ...
                              Column(
                                  ...
                                  children: [
                                    ...
                                    controller.loading.value? const CustomElevatedLoadingButton(): CustomButton(
                                      buttonWidth: MediaQuery.of(context).size.width,
                                      onPressed: () {
                                       if(authController.registerFormKey.currentState!.validate()){
                                        authController.moreSignUpToFireStore(uid: widget.uid, image:widget.image, type: widget.userType);
                    
                                       }
                                      },
                                      titleText: AppStrings.submit,
