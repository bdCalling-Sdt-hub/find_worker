...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  Future<void> getUserinfo() async {
    ...
    FirebaseFirestore.instance.collection(AppConstants.users).doc(user!.uid).get()
        .then((value){
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        ...
        child: Scaffold(
          ...
          body: isScreenLoading ? const Center(child:CircularProgressIndicator(),): LayoutBuilder(
