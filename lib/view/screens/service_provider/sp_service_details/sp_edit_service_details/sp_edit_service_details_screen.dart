...
class SpEditServiceDetailsScreen extends StatefulWidget {
  const SpEditServiceDetailsScreen({super.key});

  @override
  State<SpEditServiceDetailsScreen> createState() =>
      _SpEditServiceDetailsScreenState();
}
class _SpEditServiceDetailsScreenState extends State<SpEditServiceDetailsScreen> {
  int selectedItem = 0;
