...
class SpOtpScreen extends StatefulWidget {
  const SpOtpScreen({super.key});

  @override
  State<SpOtpScreen> createState() => _SpOtpScreenState();
}

class _SpOtpScreenState extends State<SpOtpScreen> {
/*  @override
  void initState() {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: InkWell(
                        onTap: (){
                          Get.toNamed(AppRoute.spResetPasswordScreen);
                        },
                        child: const Center(
                            child: CustomText(
