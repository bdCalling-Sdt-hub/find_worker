    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: LayoutBuilder(builder: (BuildContext context, BoxConstraints constraints) {
          return  Obx(()=> _controller.loading.value?const CustomLoader():_controller.historyList.isEmpty?Center(
            child: Column(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Column(
                      children: List.generate(_controller.historyList.length, (index) {
                        final demoData=_controller.historyList[index];
                        return GestureDetector(
                          onTap: (){
                            Get.to(SpHistoryDetailsScreen(historyModel: demoData, index:index,));
                          },
                          child: Container(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              CustomText(
                                                left: 4,
                                                text: DateFormat.jm().format(demoData.createAt!),
