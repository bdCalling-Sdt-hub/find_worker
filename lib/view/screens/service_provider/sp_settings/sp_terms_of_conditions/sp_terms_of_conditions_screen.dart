...
import 'package:wocontacts/view/screens/user/settings/Controller/setting_controller.dart';
...
class SpTermsOfConditionsScreen extends StatefulWidget {
  const SpTermsOfConditionsScreen({super.key});

  @override
  State<SpTermsOfConditionsScreen> createState() => _SpTermsOfConditionsScreenState();
}
...
class _SpTermsOfConditionsScreenState extends State<SpTermsOfConditionsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text(AppStrings.termsOfConditions.tr),leading:CustomBack(),),
