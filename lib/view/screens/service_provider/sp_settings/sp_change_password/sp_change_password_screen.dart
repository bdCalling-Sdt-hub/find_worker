...
import 'package:wocontacts/view/screens/service_provider/sp_settings/Controller/setting_controller.dart';
...
class _SpChangePasswordScreenState extends State<SpChangePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text(AppStrings.changePassword.tr),leading:CustomBack(),),
